...
<body <?php body_class(); ?>>
  ...
  <div class="flex flex-col min-h-screen">
    ...
    <section class="section-about relative z-30">
      <div class="container">
    ...
    <?php if ($projects->have_posts()): ?>
      <section class="catalog-section">
        <div class="container">
          <div class="catalog-section__headline">
            <div class="catalog-section__headline-title">Каталог</div>
            <a href="<?php echo get_term_link(5, 'project_category'); ?>" class="catalog-section__headline-all">Смотреть все<span></span></a>
          </div>
          <div class="grid grid-cols-3 gap-x-6 gap-y-3 my-6">
          ...
          <div class="catalog-section__all">
            <a href="<?php echo get_term_link(5, 'project_category'); ?>" class="catalog-section__all-button">Показать все проекты</a>
          </div>
        </div>
      </section>
    <?php endif ?>
